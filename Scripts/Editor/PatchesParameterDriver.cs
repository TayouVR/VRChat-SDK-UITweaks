    ...
    public partial class Patches {
        ...
        private class PatchParameterDriver {
            ...
            public static bool Prefix(AvatarParameterDriverEditor __instance) {
	            ...
	            if (!ParameterDriverLists.TryGetValue(__instance, out var data)) {
		            ParameterDriverLists[__instance] = data = new ParameterDriverData(__instance);
	            }
        ...
        /// </summary>
        [HarmonyPostfix]
        [HarmonyPatch(typeof(AvatarParameterDriverEditor), nameof(AvatarParameterDriverEditor.Destroy))]
        // ReSharper disable once InconsistentNaming
        private static void ParameterDriverDestroy(AvatarParameterDriverEditor __instance) {
	        ParameterDriverLists.Remove(__instance);
        }


        public class ParameterDriverData {
	        VRCAvatarParameterDriver driver;
			string[] parameterNames;
			AnimatorControllerParameterType[] parameterTypes;
			private ReorderableList list;
			private SerializedObject serializedObject;
			private VRC_AvatarParameterDriver target;
			private AvatarParameterDriverEditor _parameterDriverEditor;

			public ParameterDriverData(AvatarParameterDriverEditor __instance) {
				this.serializedObject = __instance.serializedObject;
				this.target = (VRC_AvatarParameterDriver) __instance.target;
				_parameterDriverEditor = __instance;
